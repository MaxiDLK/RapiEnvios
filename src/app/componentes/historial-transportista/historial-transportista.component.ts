...
@Component({
  selector: 'app-historial-transportista',
  templateUrl: './historial-transportista.component.html',
  styleUrls: ['./historial-transportista.component.scss'],
})
export class HistorialTransportistaComponent  implements OnInit {
